...
!function(i, v) {
    ...
    w.prototype.render = function() {
        ...
        lay(e).html((f = [],
        n = [],
        "datetime" === o.type && f.push('<span lay-type="datetime" class="' + I + '">' + d.timeTips + "</span>"),
        (o.range || "datetime" !== o.type || o.fullPanel) && f.push('<span class="' + x + '" title="' + d.preview + '"></span>'),
        ...
        y.appendChild(f)),
        r.remove(w.thisElemDate),
        D.thisId = o.id,
        s ? o.elem.append(y) : (v.body.appendChild(y),
        r.position()),
        o.shade ? '<div class="' + k + '" style="z-index:' + (parseInt(layui.getStyle(y, "z-index")) - 1) + "; background-color: " + (o.shade[1] || "#000") + "; opacity: " + (o.shade[0] || o.shade) + '"></div>' : "");
        y.insertAdjacentHTML("beforebegin", t),
        r.checkDate().calendar(null, 0, "init"),
        r.changeEvent(),
        w.thisElemDate = r.elemID,
        r.renderAdditional(),
    ...
    w.prototype.calendar = function(e, t, a) {
        ...
        lay.each(c, function(e, t) {
            ...
            o.rangeLinked || a + 1 === d.date && t.addClass(C)) : (a = e - r - i,
    ...
    w.prototype.list = function(n, i) {
        var l, r, e, a, o, d, t, s = this, y = s.config, m = s.rangeLinked ? y.dateTime : [y.dateTime, s.endDate][i], c = s.lang(), u = y.range && "date" !== y.type && "datetime" !== y.type, h = lay.elem("ul", {
            "class": L + " " + {
                year: "laydate-year-list",
                month: "laydate-month-list",
                time: "laydate-time-list"
            }[n]
        }), f = s.elemHeader[i], p = lay(f[2]).find("span"), g = s.elemCont[i || 0], v = lay(g).find("." + L)[0], D = "cn" === y.lang, T = D ? "\u5e74" : "", x = s.listYM[i] || {}, k = ["hours", "minutes", "seconds"], w = ["startTime", "endTime"][i];
        return x[0] < 1 && (x[0] = 1),
        "year" === n ? (e = l = x[0] - 7,
        l < 1 && (e = l = 1),
        ...
        ,
        y.range ? s[w] || (s[w] = "startTime" === w ? m : s.endDate) : s[w] = m,
        ...
        p = -1 !== y.format.indexOf("m"),
        t = -1 !== y.format.indexOf("s"),
        a = h.children,
        o = 0,
        lay.each([e, p, t], function(e, t) {
        ...
        t = lay(f[2]).find("." + S),
        d(),
        p.innerHTML = y.range ? [c.startTime, c.endTime][i] : c.timeTips,
        lay(s.elemMain[i]).addClass("laydate-time-show"),
        t[0] && t.remove(),
        f[2].appendChild(p),
        (v = lay(h).find("ol")).each(function(t) {
            var a = this;
            lay(a).find("li").on("click", function() {
                var e = 0 | this.innerHTML;
                lay(this).hasClass(M) || (y.range ? s[w][k[t]] = e : m[k[t]] = e,
    ...
    w.prototype.stampRange = function() {
        ...
        l.range && !i.endState && lay(i.footer).find(E).addClass(M),
        r = r && i.newDate({
            year: r.year,
            month: r.month,
            date: r.date
    ...
    l.run = function(n) {
        n(v).on("mousedown", function(e) {
            ...
            var t;
            D.thisId && (t = s.getThis(D.thisId)) && "static" !== t.config.position && 13 === e.keyCode && n("#" + t.elemID)[0] && t.elemID === w.thisElemDate && (e.preventDefault(),
...
layui.define(["lay", "layer", "util"], function(e) {
    ...
    "form")
      ...
      , i = (t.prototype.set = function(e) {
        return w.extend(!0, this.config, e),
        this
    }
    ,
    t.prototype.verify = function(e) {
        return w.extend(!0, this.config.verify, e),
        this
    }
    ,
    ...
    t.prototype.render = function(e, t) {
        var i = this.config
          ...
          , n = {
            input: function(e) {
                ...
                function(e, t) {
                    var i = e.val()
                      ...
                      , o = "click" !== t && "" === i
                      , c = "init" === t;
                    isNaN(a) || ("click" === t && (a = !!w(this).index() ? a - n : a + n),
                    t = function(e) {
                ...
                a.find("input[lay-affix],textarea[lay-affix]").each(function() {
                    var r = w(this)
                      ...
                      , n = function(i) {
                        ...
                        var a, t = w('<div class="' + u + '">'), e = layui.isArray(i.value) ? i.value : [i.value], e = w((a = [],
                        ...
                        e.on("click", function() {
                            ...
                            w(this).hasClass(F) || ("function" == typeof i.click && i.click.call(this, r, i),
            ...
            select: function(e) {
                var p, u = "\u8bf7\u9009\u62e9", m = "layui-form-select", x = "layui-select-title", g = "layui-select-none", b = "layui-select-create-option", k = "", e = e || a.find("select"), C = function(e, t) {
                    w(e.target).parent().hasClass(x) && !t || ((e = w("." + m)).removeClass(m + "ed " + m + "up"),
                    e.hasClass("layui-select-creatable") && e.children("dl").children("." + b).remove(),
                    p && k && p.val(k)),
                    p = null
                }, d = function(a, e, t, o) {
                    var s, c, i, n, u, l, r = w(this), d = a.find("." + x), f = d.find("input"), h = a.find("dl"), y = (h.children("dd"),
                    h.children("dt")), v = this.selectedIndex;
                    e || (c = r.attr("lay-search"),
                    i = function() {
                        ...
                        s = null,
                        i.removeClass(T),
                        0 <= v && i.eq(v).addClass(T),
                        e + t > A.height() && t <= e && a.addClass(m + "up"),
                        u()
                    }
                    ,
                    n = function(e) {
                        ...
                        f.blur(),
                        s = null,
                        o && h.children("." + b).remove(),
                        e || l(f.val(), function(e) {
                            var t = r[0].selectedIndex;
                            e && (k = w(r[0].options[t]).html(),
                            0 === t && k === f.attr("placeholder") && (k = ""),
                            f.val(k || ""))
                        })
                    }
                    ,
                    u = function() {
                        ...
                        t = h.height(),
                        i = i.height(),
                        t < e && h.scrollTop(e + h.scrollTop() - t + i - 5),
                        e < 0) && h.scrollTop(e + h.scrollTop() - 5)
                    }
                    ,
                            ...
                            var e = function() {
                                ...
                                if (h.children("dd." + $)[0] && "next" === a) {
                                    ...
                                    if (0 <= i && i < e.index() && !t.hasClass(T))
                                        return t.eq(0).prev()[0] ? t.eq(0).prev() : h.children(":last")
                                }
                        ...
                        var l = 0
                          ...
                          , t = (layui.each(t, function() {
                            var e = w(this)
                              , t = e.text()
                              , i = (o && t === s && (r = !0),
                            "cs" !== c && (t = t.toLowerCase(),
                            a = a.toLowerCase()),
                            -1 === t.indexOf(a));
                            ("" === a || "blur" === n ? a !== t : i) && l++,
                            "keyup" === n && e[!i || o && e.hasClass(b) ? "removeClass" : "addClass"]($)
                        }),
                    ...
                    lay.ie && ("10" === lay.ie || "11" === lay.ie) && f.attr("placeholder") && (e = "keyup"),
                    f.on(e, function(e) {
                        var a = this.value
                          , e = e.keyCode;
                        ...
                        l(a, function(e, t) {
                            var i;
                            o ? t ? h.children("." + b).remove() : (t = w("<div>" + a + "</div>").text(),
                            (i = h.children("." + b))[0] ? (i.attr("lay-value", a),
                            i.text(t)) : h.append('<dd class="' + b + '" lay-value="' + a + '">' + t + "</dd>")) : e ? h.find("." + g)[0] || h.append('<p class="' + g + '">\u65e0\u5339\u914d\u9879</p>') : h.find("." + g).remove()
                        }, "keyup"),
                        "" === a && (r.val(""),
                        h.find("." + T).removeClass(T),
                        (r[0].options[0] || {}).value || h.children("dd:eq(0)").addClass(T),
                        h.find("." + g).remove(),
                        o) && h.children("." + b).remove(),
                        u()
                    }).on("blur", function(e) {
                    ...
                    h.on("click", "dd", function() {
                        var e = w(this)
                          , t = e.attr("lay-value")
                          , i = r.attr("lay-filter");
                        return e.hasClass(F) || (e.hasClass("layui-select-tips") ? f.val("") : (f.val(e.text()),
                        e.addClass(T)),
                        o && e.hasClass(b) && (e.removeClass(b),
            ...
            radio: function(e) {
                ...
                e.each(function(e, t) {
                    ...
                    if ("string" == typeof i.attr("lay-ignore"))
                        return i.show();
                    a[0] && a.remove();
                    n = w(['<div class="layui-unselect ' + r, t.checked ? " " + r + "ed" : "", (n ? " layui-radio-disabled " + F : "") + '">', '<i class="layui-anim layui-icon ' + s[t.checked ? 0 : 1] + '"></i>', "<div>" + (a = f.escape(t.title || ""),
        ...
        return "object" === layui.type(e) ? w(e).is(o) ? (a = w(e),
